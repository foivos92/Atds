...
public class HistogramFull extends Configured implements Tool{
	...
	float sum1 = 0;
        try{
            for (int j = 0; j < 28; j++) {
                ...
                temp1 = (float)temp/sum*100;
		sum1+= temp1;
                out.writeBytes(Res[j][0]+" "+Res[j][1] +" "+Float.toString(temp1)+"%\n");
            }
	out.writeBytes(Float.toString(sum1)+"%\n");
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(), new HistogramFull(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage: Histogramfull <in> [<in>...] <out>");
            System.exit(2);
        }

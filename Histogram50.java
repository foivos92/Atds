...
public class Histogram50 extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(), new Histogram50(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage: Histogram50 <in> [<in>...] <out>");
            System.exit(2);
        }
